...
public interface UserMapper {
    ...
    @Mapping(target = "profilePhotoUrl", ignore = true)
    @Mapping(target = "studentId", ignore = true)
    UserEntity toEntity(CreateAccountRequest request);
    ...
    @Mapping(target = "userType", source = "primaryRole")
    UserProfileResponse.UserInfo toUserInfo(UserEntity user);

    void updateUserFromRequest(UpdateAccountRequest request, @MappingTarget UserEntity user);
}
